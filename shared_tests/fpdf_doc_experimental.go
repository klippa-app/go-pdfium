...
var _ = Describe("fpdf_doc_experimental", func() {
	...
	Context("a PDF file with bookmarks", func() {
		...
		BeforeEach(func() {
			pdfData, err := os.ReadFile(TestDataPath + "/testdata/bookmarks.pdf")
			Expect(err).To(BeNil())
	...
	Context("a PDF file with colored bookmarks", func() {
		...
		BeforeEach(func() {
			pdfData, err := os.ReadFile(TestDataPath + "/testdata/bookmarks_with_color.pdf")
			Expect(err).To(BeNil())
	...
	Context("a PDF file with styled bookmarks", func() {
		...
		BeforeEach(func() {
			pdfData, err := os.ReadFile(TestDataPath + "/testdata/bookmarks_with_style.pdf")
			Expect(err).To(BeNil())
	...
	Context("a PDF file with no page labels", func() {
		...
		BeforeEach(func() {
			pdfData, err := os.ReadFile(TestDataPath + "/testdata/about_blank.pdf")
			Expect(err).To(BeNil())
	...
	Context("a PDF file with page labels", func() {
		...
		BeforeEach(func() {
			pdfData, err := os.ReadFile(TestDataPath + "/testdata/page_labels.pdf")
			Expect(err).To(BeNil())
	...
	Context("a PDF file with a non-text identifier", func() {
		...
		BeforeEach(func() {
			pdfData, err := os.ReadFile(TestDataPath + "/testdata/split_streams.pdf")
			Expect(err).To(BeNil())
	...
	Context("a PDF file with a text identifier", func() {
		...
		BeforeEach(func() {
			pdfData, err := os.ReadFile(TestDataPath + "/testdata/non_hex_file_id.pdf")
			Expect(err).To(BeNil())
	...
	Context("a PDF file with an embedded goto action", func() {
		...
		var link references.FPDF_LINK
		BeforeEach(func() {
			pdfData, err := os.ReadFile(TestDataPath + "/testdata/gotoe_action.pdf")
			Expect(err).To(BeNil())
	...
	Context("a PDF file with a link dest", func() {
		...
		var link references.FPDF_LINK
		BeforeEach(func() {
			pdfData, err := os.ReadFile(TestDataPath + "/testdata/bug_821454.pdf")
			Expect(err).To(BeNil())
	...
	Context("a PDF file with an aaction", func() {
		var doc references.FPDF_DOCUMENT
		BeforeEach(func() {
			pdfData, err := os.ReadFile(TestDataPath + "/testdata/get_page_aaction.pdf")
			Expect(err).To(BeNil())
