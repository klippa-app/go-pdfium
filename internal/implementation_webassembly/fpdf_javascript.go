...
func (p *PdfiumImplementation) FPDFDoc_GetJavaScriptAction(request *requests.FPDFDoc_GetJavaScriptAction) (*responses.FPDFDoc_GetJavaScriptAction, error) {
	...
	res, err := p.call("FPDFDoc_GetJavaScriptAction", *documentHandle.handle, *(*uint64)(unsafe.Pointer(&request.Index)))
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFDoc_CloseJavaScriptAction(request *requests.FPDFDoc_CloseJavaScriptAction) (*responses.FPDFDoc_CloseJavaScriptAction, error) {
	...
	_, err = p.call("FPDFDoc_CloseJavaScriptAction", *javaScriptActionHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFJavaScriptAction_GetName(request *requests.FPDFJavaScriptAction_GetName) (*responses.FPDFJavaScriptAction_GetName, error) {
	...
	res, err := p.call("FPDFJavaScriptAction_GetName", *javaScriptActionHandle.handle, 0, 0)
	if err != nil {
		return nil, err
	}
	...
	res, err = p.call("FPDFJavaScriptAction_GetName", *javaScriptActionHandle.handle, charDataPointer.Pointer, nameSize)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFJavaScriptAction_GetScript(request *requests.FPDFJavaScriptAction_GetScript) (*responses.FPDFJavaScriptAction_GetScript, error) {
	...
	res, err := p.call("FPDFJavaScriptAction_GetScript", *javaScriptActionHandle.handle, 0, 0)
	if err != nil {
		return nil, err
	}
	...
	res, err = p.call("FPDFJavaScriptAction_GetScript", *javaScriptActionHandle.handle, charDataPointer.Pointer, scriptSize)
	if err != nil {
		return nil, err
	}
