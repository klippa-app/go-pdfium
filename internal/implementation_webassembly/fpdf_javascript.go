...
func (p *PdfiumImplementation) FPDFDoc_GetJavaScriptActionCount(request *requests.FPDFDoc_GetJavaScriptActionCount) (*responses.FPDFDoc_GetJavaScriptActionCount, error) {
	...
	res, err := p.Fn("FPDFDoc_GetJavaScriptActionCount").Call(p.Context, *documentHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFDoc_GetJavaScriptAction(request *requests.FPDFDoc_GetJavaScriptAction) (*responses.FPDFDoc_GetJavaScriptAction, error) {
	...
	res, err := p.Fn("FPDFDoc_GetJavaScriptAction").Call(p.Context, *documentHandle.handle, *(*uint64)(unsafe.Pointer(&request.Index)))
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFDoc_CloseJavaScriptAction(request *requests.FPDFDoc_CloseJavaScriptAction) (*responses.FPDFDoc_CloseJavaScriptAction, error) {
	...
	_, err = p.Fn("FPDFDoc_CloseJavaScriptAction").Call(p.Context, *javaScriptActionHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFJavaScriptAction_GetName(request *requests.FPDFJavaScriptAction_GetName) (*responses.FPDFJavaScriptAction_GetName, error) {
	...
	res, err := p.Fn("FPDFJavaScriptAction_GetName").Call(p.Context, *javaScriptActionHandle.handle, 0, 0)
	if err != nil {
		return nil, err
	}
	...
	res, err = p.Fn("FPDFJavaScriptAction_GetName").Call(p.Context, *javaScriptActionHandle.handle, charDataPointer.Pointer, nameSize)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFJavaScriptAction_GetScript(request *requests.FPDFJavaScriptAction_GetScript) (*responses.FPDFJavaScriptAction_GetScript, error) {
	...
	res, err := p.Fn("FPDFJavaScriptAction_GetScript").Call(p.Context, *javaScriptActionHandle.handle, 0, 0)
	if err != nil {
		return nil, err
	}
	...
	res, err = p.Fn("FPDFJavaScriptAction_GetScript").Call(p.Context, *javaScriptActionHandle.handle, charDataPointer.Pointer, scriptSize)
	if err != nil {
		return nil, err
	}
