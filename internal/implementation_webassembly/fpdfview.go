...
func (p *PdfiumImplementation) FPDF_SetSandBoxPolicy(request *requests.FPDF_SetSandBoxPolicy) (*responses.FPDF_SetSandBoxPolicy, error) {
	...
	_, err := p.call("FPDF_SetSandBoxPolicy", uint64(request.Policy), enable)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_LoadPage(request *requests.FPDF_LoadPage) (*responses.FPDF_LoadPage, error) {
	...
	pageObject, err := p.call("FPDF_LoadPage", *documentHandle.handle, uint64(request.Index))
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_GetFileVersion(request *requests.FPDF_GetFileVersion) (*responses.FPDF_GetFileVersion, error) {
	...
	success, err := p.call("FPDF_GetFileVersion", *documentHandle.handle, fileVersion.Pointer)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_GetDocPermissions(request *requests.FPDF_GetDocPermissions) (*responses.FPDF_GetDocPermissions, error) {
	...
	res, err := p.call("FPDF_GetDocPermissions", *documentHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_GetDocUserPermissions(request *requests.FPDF_GetDocUserPermissions) (*responses.FPDF_GetDocUserPermissions, error) {
	...
	res, err := p.call("FPDF_GetDocUserPermissions", *documentHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_GetSecurityHandlerRevision(request *requests.FPDF_GetSecurityHandlerRevision) (*responses.FPDF_GetSecurityHandlerRevision, error) {
	...
	res, err := p.call("FPDF_GetSecurityHandlerRevision", *documentHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_GetPageCount(request *requests.FPDF_GetPageCount) (*responses.FPDF_GetPageCount, error) {
	...
	res, err := p.call("FPDF_GetPageCount", *documentHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_GetPageSizeByIndex(request *requests.FPDF_GetPageSizeByIndex) (*responses.FPDF_GetPageSizeByIndex, error) {
	...
	res, err := p.call("FPDF_GetPageSizeByIndex", *documentHandle.handle, uint64(request.Index), widthPointer.Pointer, heightPointer.Pointer)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_RenderPageBitmap(request *requests.FPDF_RenderPageBitmap) (*responses.FPDF_RenderPageBitmap, error) {
	...
	_, err = p.call("FPDF_RenderPageBitmap", *bitmapHandle.handle, *pageHandle.handle, uint64(request.StartX), uint64(request.StartY), uint64(request.SizeX), uint64(request.SizeY), uint64(request.Rotate), uint64(request.Flags))
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_RenderPageBitmapWithMatrix(request *requests.FPDF_RenderPageBitmapWithMatrix) (*responses.FPDF_RenderPageBitmapWithMatrix, error) {
	...
	_, err = p.call("FPDF_RenderPageBitmapWithMatrix", *bitmapHandle.handle, *pageHandle.handle, matrix, clipping, uint64(request.Flags))
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_DeviceToPage(request *requests.FPDF_DeviceToPage) (*responses.FPDF_DeviceToPage, error) {
	...
	res, err := p.call("FPDF_DeviceToPage", *pageHandle.handle, uint64(request.StartX), uint64(request.StartY), uint64(request.SizeX), uint64(request.SizeY), uint64(request.Rotate), uint64(request.DeviceX), uint64(request.DeviceY), pageXPointer.Pointer, pageYPointer.Pointer)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_PageToDevice(request *requests.FPDF_PageToDevice) (*responses.FPDF_PageToDevice, error) {
	...
	res, err := p.call("FPDF_PageToDevice", *pageHandle.handle, uint64(request.StartX), uint64(request.StartY), uint64(request.SizeX), uint64(request.SizeY), uint64(request.Rotate), *(*uint64)(unsafe.Pointer(&request.PageX)), *(*uint64)(unsafe.Pointer(&request.PageY)), deviceXPointer.Pointer, deviceYPointer.Pointer)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFBitmap_Create(request *requests.FPDFBitmap_Create) (*responses.FPDFBitmap_Create, error) {
	...
	res, err := p.call("FPDFBitmap_Create", uint64(request.Width), uint64(request.Height), uint64(request.Alpha))
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFBitmap_CreateEx(request *requests.FPDFBitmap_CreateEx) (*responses.FPDFBitmap_CreateEx, error) {
	...
	res, err := p.call("FPDFBitmap_CreateEx", uint64(request.Width), uint64(request.Height), uint64(request.Format), pointer, uint64(request.Stride))
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFBitmap_GetFormat(request *requests.FPDFBitmap_GetFormat) (*responses.FPDFBitmap_GetFormat, error) {
	...
	res, err := p.call("FPDFBitmap_GetFormat", *bitmapHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFBitmap_FillRect(request *requests.FPDFBitmap_FillRect) (*responses.FPDFBitmap_FillRect, error) {
	...
	_, err = p.call("FPDFBitmap_FillRect", *bitmapHandle.handle, uint64(request.Left), uint64(request.Top), uint64(request.Width), uint64(request.Height), uint64(request.Color))
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFBitmap_GetBuffer(request *requests.FPDFBitmap_GetBuffer) (*responses.FPDFBitmap_GetBuffer, error) {
	...
	res, err := p.call("FPDFBitmap_GetStride", *bitmapHandle.handle)
	if err != nil {
		return nil, err
	}
	...
	res, err = p.call("FPDFBitmap_GetHeight", *bitmapHandle.handle)
	if err != nil {
		return nil, err
	}
	...
	res, err = p.call("FPDFBitmap_GetBuffer", *bitmapHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFBitmap_GetWidth(request *requests.FPDFBitmap_GetWidth) (*responses.FPDFBitmap_GetWidth, error) {
	...
	res, err := p.call("FPDFBitmap_GetWidth", *bitmapHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFBitmap_Destroy(request *requests.FPDFBitmap_Destroy) (*responses.FPDFBitmap_Destroy, error) {
	...
	_, err = p.call("FPDFBitmap_Destroy", *bitmapHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_VIEWERREF_GetPrintScaling(request *requests.FPDF_VIEWERREF_GetPrintScaling) (*responses.FPDF_VIEWERREF_GetPrintScaling, error) {
	...
	res, err := p.call("FPDF_VIEWERREF_GetPrintScaling", *documentHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_VIEWERREF_GetNumCopies(request *requests.FPDF_VIEWERREF_GetNumCopies) (*responses.FPDF_VIEWERREF_GetNumCopies, error) {
	...
	res, err := p.call("FPDF_VIEWERREF_GetNumCopies", *documentHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_VIEWERREF_GetPrintPageRange(request *requests.FPDF_VIEWERREF_GetPrintPageRange) (*responses.FPDF_VIEWERREF_GetPrintPageRange, error) {
	...
	res, err := p.call("FPDF_VIEWERREF_GetPrintPageRange", *documentHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_VIEWERREF_GetDuplex(request *requests.FPDF_VIEWERREF_GetDuplex) (*responses.FPDF_VIEWERREF_GetDuplex, error) {
	...
	res, err := p.call("FPDF_VIEWERREF_GetDuplex", *documentHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_VIEWERREF_GetName(request *requests.FPDF_VIEWERREF_GetName) (*responses.FPDF_VIEWERREF_GetName, error) {
	...
	res, err := p.call("FPDF_VIEWERREF_GetName", *documentHandle.handle, cstr.Pointer, 0, 0)
	if err != nil {
		return nil, err
	}
	...
	_, err = p.call("FPDF_VIEWERREF_GetName", *documentHandle.handle, cstr.Pointer, charDataPointer.Pointer, nameSize)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_CountNamedDests(request *requests.FPDF_CountNamedDests) (*responses.FPDF_CountNamedDests, error) {
	...
	res, err := p.call("FPDF_CountNamedDests", *documentHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_GetNamedDestByName(request *requests.FPDF_GetNamedDestByName) (*responses.FPDF_GetNamedDestByName, error) {
	...
	res, err := p.call("FPDF_GetNamedDestByName", *documentHandle.handle, cstr.Pointer)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_GetNamedDest(request *requests.FPDF_GetNamedDest) (*responses.FPDF_GetNamedDest, error) {
	...
	_, err = p.call("FPDF_GetNamedDest", *documentHandle.handle, uint64(request.Index), 0, bufLenPointer.Pointer)
	if err != nil {
		return nil, err
	}
	...
	res, err := p.call("FPDF_GetNamedDest", *documentHandle.handle, uint64(request.Index), charDataPointer.Pointer, bufLenPointer.Pointer)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_DocumentHasValidCrossReferenceTable(request *requests.FPDF_DocumentHasValidCrossReferenceTable) (*responses.FPDF_DocumentHasValidCrossReferenceTable, error) {
	...
	res, err := p.call("FPDF_DocumentHasValidCrossReferenceTable", *documentHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_GetTrailerEnds(request *requests.FPDF_GetTrailerEnds) (*responses.FPDF_GetTrailerEnds, error) {
	...
	res, err := p.call("FPDF_GetTrailerEnds", *documentHandle.handle, 0, 0)
	if err != nil {
		return nil, err
	}
	...
	res, err = p.call("FPDF_GetTrailerEnds", *documentHandle.handle, cTrailerEndsPointer.Pointer, uint64(trailerSize))
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_GetPageWidthF(request *requests.FPDF_GetPageWidthF) (*responses.FPDF_GetPageWidthF, error) {
	...
	res, err := p.call("FPDF_GetPageWidthF", *pageHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_GetPageHeightF(request *requests.FPDF_GetPageHeightF) (*responses.FPDF_GetPageHeightF, error) {
	...
	res, err := p.call("FPDF_GetPageHeightF", *pageHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_GetPageBoundingBox(request *requests.FPDF_GetPageBoundingBox) (*responses.FPDF_GetPageBoundingBox, error) {
	...
	res, err := p.call("FPDF_GetPageBoundingBox", *pageHandle.handle, rectPointer)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_GetPageSizeByIndexF(request *requests.FPDF_GetPageSizeByIndexF) (*responses.FPDF_GetPageSizeByIndexF, error) {
	...
	res, err := p.call("FPDF_GetPageSizeByIndexF", *documentHandle.handle, uint64(request.Index), sizePointer)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_VIEWERREF_GetPrintPageRangeCount(request *requests.FPDF_VIEWERREF_GetPrintPageRangeCount) (*responses.FPDF_VIEWERREF_GetPrintPageRangeCount, error) {
	...
	res, err := p.call("FPDF_VIEWERREF_GetPrintPageRangeCount", *pageRangeHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_VIEWERREF_GetPrintPageRangeElement(request *requests.FPDF_VIEWERREF_GetPrintPageRangeElement) (*responses.FPDF_VIEWERREF_GetPrintPageRangeElement, error) {
	...
	res, err := p.call("FPDF_VIEWERREF_GetPrintPageRangeElement", *pageRangeHandle.handle, uint64(request.Index))
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_GetXFAPacketCount(request *requests.FPDF_GetXFAPacketCount) (*responses.FPDF_GetXFAPacketCount, error) {
	...
	res, err := p.call("FPDF_GetXFAPacketCount", *documentHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_GetXFAPacketName(request *requests.FPDF_GetXFAPacketName) (*responses.FPDF_GetXFAPacketName, error) {
	...
	res, err := p.call("FPDF_GetXFAPacketName", *documentHandle.handle, uint64(request.Index), 0, 0)
	if err != nil {
		return nil, err
	}
	...
	res, err = p.call("FPDF_GetXFAPacketName", *documentHandle.handle, uint64(request.Index), charDataPointer.Pointer, nameSize)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_GetXFAPacketContent(request *requests.FPDF_GetXFAPacketContent) (*responses.FPDF_GetXFAPacketContent, error) {
	...
	// First get the name length.
	res, err := p.call("FPDF_GetXFAPacketContent", *documentHandle.handle, uint64(request.Index), 0, 0, outBufLenPointer.Pointer)
	if err != nil {
		return nil, err
	}
	...
	res, err = p.call("FPDF_GetXFAPacketContent", *documentHandle.handle, uint64(request.Index), contentDataPointer.Pointer, outBufLen, outBufLenPointer.Pointer)
	if err != nil {
		return nil, err
	}
