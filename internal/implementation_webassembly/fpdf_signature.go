...
func (p *PdfiumImplementation) FPDF_GetSignatureCount(request *requests.FPDF_GetSignatureCount) (*responses.FPDF_GetSignatureCount, error) {
	...
	res, err := p.call("FPDF_GetSignatureCount", *documentHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_GetSignatureObject(request *requests.FPDF_GetSignatureObject) (*responses.FPDF_GetSignatureObject, error) {
	...
	res, err := p.call("FPDF_GetSignatureObject", *documentHandle.handle, *(*uint64)(unsafe.Pointer(&request.Index)))
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFSignatureObj_GetContents(request *requests.FPDFSignatureObj_GetContents) (*responses.FPDFSignatureObj_GetContents, error) {
	...
	res, err := p.call("FPDFSignatureObj_GetContents", *signatureHandle.handle, 0, 0)
	if err != nil {
		return nil, err
	}
	...
	res, err = p.call("FPDFSignatureObj_GetContents", *signatureHandle.handle, signatureDataPointer.Pointer, signatureSize)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFSignatureObj_GetByteRange(request *requests.FPDFSignatureObj_GetByteRange) (*responses.FPDFSignatureObj_GetByteRange, error) {
	...
	// First get the signature length.
	res, err := p.call("FPDFSignatureObj_GetByteRange", *signatureHandle.handle, 0, 0)
	if err != nil {
		return nil, err
	}
	...
	_, err = p.call("FPDFSignatureObj_GetByteRange", *signatureHandle.handle, intArrayPointer.Pointer, byteRangeSize)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFSignatureObj_GetSubFilter(request *requests.FPDFSignatureObj_GetSubFilter) (*responses.FPDFSignatureObj_GetSubFilter, error) {
	...
	// First get the signature length.
	res, err := p.call("FPDFSignatureObj_GetSubFilter", *signatureHandle.handle, 0, 0)
	if err != nil {
		return nil, err
	}
	...
	res, err = p.call("FPDFSignatureObj_GetSubFilter", *signatureHandle.handle, subFilterDataPointer.Pointer, subFilterLength)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFSignatureObj_GetReason(request *requests.FPDFSignatureObj_GetReason) (*responses.FPDFSignatureObj_GetReason, error) {
	...
	res, err := p.call("FPDFSignatureObj_GetReason", *signatureHandle.handle, 0, 0)
	if err != nil {
		return nil, err
	}
	...
	res, err = p.call("FPDFSignatureObj_GetReason", *signatureHandle.handle, reasonDataPointer.Pointer, reasonLength)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFSignatureObj_GetTime(request *requests.FPDFSignatureObj_GetTime) (*responses.FPDFSignatureObj_GetTime, error) {
	...
	res, err := p.call("FPDFSignatureObj_GetTime", *signatureHandle.handle, 0, 0)
	if err != nil {
		return nil, err
	}
	...
	res, err = p.call("FPDFSignatureObj_GetTime", *signatureHandle.handle, timeDataPointer.Pointer, timeLength)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFSignatureObj_GetDocMDPPermission(request *requests.FPDFSignatureObj_GetDocMDPPermission) (*responses.FPDFSignatureObj_GetDocMDPPermission, error) {
	...
	res, err := p.call("FPDFSignatureObj_GetDocMDPPermission", *signatureHandle.handle)
	if err != nil {
		return nil, err
	}
