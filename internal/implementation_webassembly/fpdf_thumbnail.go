...
func (p *PdfiumImplementation) FPDFPage_GetDecodedThumbnailData(request *requests.FPDFPage_GetDecodedThumbnailData) (*responses.FPDFPage_GetDecodedThumbnailData, error) {
	...
	res, err := p.Fn("FPDFPage_GetDecodedThumbnailData").Call(p.Context, *pageHandle.handle, 0, 0)
	if err != nil {
		return nil, err
	}
	...
	_, err = p.Fn("FPDFPage_GetDecodedThumbnailData").Call(p.Context, *pageHandle.handle, thumbnailDataPointer.Pointer, thumbnailLength)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFPage_GetRawThumbnailData(request *requests.FPDFPage_GetRawThumbnailData) (*responses.FPDFPage_GetRawThumbnailData, error) {
	...
	// First get the thumbnail length.
	res, err := p.Fn("FPDFPage_GetRawThumbnailData").Call(p.Context, *pageHandle.handle, 0, 0)
	if err != nil {
		return nil, err
	}
	...
	_, err = p.Fn("FPDFPage_GetRawThumbnailData").Call(p.Context, *pageHandle.handle, rawThumbnailDataPointer.Pointer, rawThumbnailLength)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFPage_GetThumbnailAsBitmap(request *requests.FPDFPage_GetThumbnailAsBitmap) (*responses.FPDFPage_GetThumbnailAsBitmap, error) {
	...
	res, err := p.Fn("FPDFPage_GetThumbnailAsBitmap").Call(p.Context, *pageHandle.handle)
	if err != nil {
		return nil, err
	}
