...
func (p *PdfiumImplementation) FPDF_ImportPages(request *requests.FPDF_ImportPages) (*responses.FPDF_ImportPages, error) {
	...
	res, err := p.Fn("FPDF_ImportPages").Call(p.Context, *destinationDocHandle.handle, *sourceDocHandle.handle, pageRange, *(*uint64)(unsafe.Pointer(&request.Index)))
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_CopyViewerPreferences(request *requests.FPDF_CopyViewerPreferences) (*responses.FPDF_CopyViewerPreferences, error) {
	...
	res, err := p.Fn("FPDF_CopyViewerPreferences").Call(p.Context, *destinationDocHandle.handle, *sourceDocHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_ImportPagesByIndex(request *requests.FPDF_ImportPagesByIndex) (*responses.FPDF_ImportPagesByIndex, error) {
	...
	res, err := p.Fn("FPDF_ImportPagesByIndex").Call(p.Context, *destinationDocHandle.handle, *sourceDocHandle.handle, pageIndicesPointer, *(*uint64)(unsafe.Pointer(&pageIndicesSize)), *(*uint64)(unsafe.Pointer(&request.Index)))
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_ImportNPagesToOne(request *requests.FPDF_ImportNPagesToOne) (*responses.FPDF_ImportNPagesToOne, error) {
	...
	res, err := p.Fn("FPDF_ImportNPagesToOne").Call(p.Context, *sourceDocHandle.handle, api.EncodeF32(request.OutputWidth), api.EncodeF32(request.OutputHeight), *(*uint64)(unsafe.Pointer(&request.NumPagesOnXAxis)), *(*uint64)(unsafe.Pointer(&request.NumPagesOnYAxis)))
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_NewXObjectFromPage(request *requests.FPDF_NewXObjectFromPage) (*responses.FPDF_NewXObjectFromPage, error) {
	...
	res, err := p.Fn("FPDF_NewXObjectFromPage").Call(p.Context, *sourceDocHandle.handle, *destinationDocHandle.handle, *(*uint64)(unsafe.Pointer(&request.SourcePageIndex)))
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_CloseXObject(request *requests.FPDF_CloseXObject) (*responses.FPDF_CloseXObject, error) {
	...
	_, err = p.Fn("FPDF_CloseXObject").Call(p.Context, *xObjectHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDF_NewFormObjectFromXObject(request *requests.FPDF_NewFormObjectFromXObject) (*responses.FPDF_NewFormObjectFromXObject, error) {
	...
	res, err := p.Fn("FPDF_NewFormObjectFromXObject").Call(p.Context, *xObjectHandle.handle)
	if err != nil {
		return nil, err
	}
