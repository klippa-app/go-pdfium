...
func (p *PdfiumImplementation) FPDFCatalog_IsTagged(request *requests.FPDFCatalog_IsTagged) (*responses.FPDFCatalog_IsTagged, error) {
	...
	res, err := p.call("FPDFCatalog_IsTagged", *documentHandle.handle)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFCatalog_GetLanguage(request *requests.FPDFCatalog_GetLanguage) (*responses.FPDFCatalog_GetLanguage, error) {
	...
	res, err := p.call("FPDFCatalog_GetLanguage", *documentHandle.handle, 0, 0)
	if err != nil {
		return nil, err
	}
	...
	_, err = p.call("FPDFCatalog_GetLanguage", *documentHandle.handle, charDataPointer.Pointer, langLength)
	if err != nil {
		return nil, err
	}
...
func (p *PdfiumImplementation) FPDFCatalog_SetLanguage(request *requests.FPDFCatalog_SetLanguage) (*responses.FPDFCatalog_SetLanguage, error) {
	...
	res, err := p.call("FPDFCatalog_SetLanguage", *documentHandle.handle, languagePointer.Pointer)
	if err != nil {
		return nil, err
	}
